...
#ifndef WASM_ENABLE_MIGRATION_STACK_MAP
#define WASM_ENABLE_MIGRATION_STACK_MAP 1
#endif

#ifndef WASM_ENABLE_MIGRATION_ADDRESS_MAP
#define WASM_ENABLE_MIGRATION_ADDRESS_MAP 1
#endif
