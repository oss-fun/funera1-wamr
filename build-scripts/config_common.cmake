...
if (NOT DEFINED WAMR_BUILD_MIGRATION_ADDRESS_MAP)
  set (WAMR_BUILD_MIGRATION_ADDRESS_MAP 1)
endif ()
if (WAMR_BUILD_MIGRATION_ADDRESS_MAP EQUAL 1)
  add_definitions (-DWASM_ENABLE_MIGRATION_ADDRESS_MAP=1)
  message ("     Migration address map enabled")
else ()
  add_definitions (-DWASM_ENABLE_MIGRATION_ADDRESS_MAP=0)
  message ("     Migration address map disabled")
endif ()
